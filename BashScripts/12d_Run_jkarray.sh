...
#SBATCH --array=1-109
#SBATCH --output=/cfs/klemming/projects/snic/snic2022-23-124/Santiago/Scripts/logs/Purging/Jackknife/FrenchControl/%x_%j_%a.out
#SBATCH --error=/cfs/klemming/projects/snic/snic2022-23-124/Santiago/Scripts/logs/Purging/Jackknife/FrenchControl/%x_%j_%a.err
#SBATCH -p shared
#SBATCH -t 3:00:00
#SBATCH --mem=500MB  
#SBATCH -N 1
